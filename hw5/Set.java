...
public class Set {
 ...
 List newSet;
  ...
  public void insert(Comparable c) {
   ListNode curr=newSet.front();
   try{
   while(c.compareTo((Comparable)curr.item())>0){
      curr=curr.next();
   }
   if(c.compareTo((Comparable)curr.item())==0){}
   else{curr.insertBefore(c);}
}
  ...
  public void intersect(Set s) {
    // Your solution here.
   ListNode insertion = newSet.front();
    ListNode retrieval = s.newSet.front();
    try {
      while (true) {
  ...
  public static void main(String[] argv) {
    ...
    s6.union(s5);
    System.out.println("After s6.union(s5), s6 = " + s6);
