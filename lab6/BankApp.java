  ...
  */
  private void doDeposit() throws IOException {
    ...
    //try ends
      ...
      System.out.println("BadTransactionException!!you can't deposit less than 0:");
    }
    //catch 1 ends
    catch(BadAccountException e){
      System.out.println("BadAccountException!!");
    }
    //catch 2 ends
  }
  ...
  private void doInquire() throws IOException {
    ...
    try{System.out.println("Balance for #" + acctNumber + " is " +
                       ATM.balanceInquiry(acctNumber));}
    catch(BadAccountException e){
      System.out.println("BadAccountException!!");
    }
