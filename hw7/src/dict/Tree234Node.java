...
class Tree234Node {
    ...
    Tree234Node(Tree234Node p, int key,Tree234Node c1, Tree234Node c2) {
        keys = 1;
        key1 = key;
        parent = p;
        child1 = c1;
    ...
    Tree234Node(Tree234Node p, int k1,int k2, Tree234Node c1,Tree234Node c2, Tree234Node c3) {
        keys = 2;
        key1 = k1;
        key2 = k2;
        parent = p;
    ...
    Tree234Node(Tree234Node p, int k1,int k2, int k3, Tree234Node c1,Tree234Node c2, Tree234Node c3, Tree234Node c4) {
        keys = 3;
        key1 = k1;
        key2 = k2;
        key3 = k3;
